...
namespace Tests.Tests.ClientePJ_Module
{
    ...
    public class DominioClientePJ_Test
    {
        ...
        public void Deve_retornar_clientePJ_valido()
        {
            ...
            ClientePJ clienteValido = new ClientePJ("nome", "99999999999", "endereco", "99999999999999", listaMotoristas);
        ...
        {
            ClientePJ clienteValido = new ClientePJ(string.Empty, string.Empty, string.Empty, string.Empty, listaMotoristas);
